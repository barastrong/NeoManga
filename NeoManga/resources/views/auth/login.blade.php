...
<head>
    ...
    <style>
        ...
        /* DIUBAH: Menambahkan class khusus untuk judul agar lebih terbaca */
        .neon-title-text {
    ...
    <div class="relative z-10 w-full">
        ...
        <div class="bg-black bg-opacity-50 glass-morphism rounded-2xl p-6 sm:p-8 w-full max-w-md mx-auto neon-border neon-glow">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl sm:text-4xl font-bold neon-title-text mb-2">LOGIN</h1>
            ...
            <form method="POST" action="/login" class="space-y-6">
                ...
                <div class="flex items-center">
                    ...
                    />
                    <label for="remember_me" class="ml-2 text-sm text-gray-300 cursor-pointer">
                        Remember me
                    </label>
                </div>
                ...
                <div class="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-4">
                    <a 
                        ...
                        class="text-sm text-center sm:text-left text-purple-400 hover:text-purple-300 transition-colors duration-300 underline"
                    >
                ...
                <div class="text-center pt-4 border-t border-gray-700">
                    <p class="text-gray-400 text-sm">
                        ...
                        <a href="/register" class="text-cyan-400 hover:text-cyan-300 transition-colors duration-300 underline">
                            Sign up
                        </a>
                    </p>
                </div>
